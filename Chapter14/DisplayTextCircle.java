 ...
 * @author Java
 */
public class DisplayTextCircle extends Application {

    private static String phrase = "Hello, there kt.";
    ...
    public void start(Stage primaryStage) {
        ...
        for (int l = 0; l < numLetters; l++) {
            ...
            yPos = radius * Math.sin(Math.toRadians(angle)) + radius + 20;

            Label letter = new Label(Character.toString(phrase.charAt(l)));
            letter.setFont(fnt);
            letter.setRotate(angle + 90);
            letter.setTranslateX(xPos);
            letter.setTranslateY(yPos);
